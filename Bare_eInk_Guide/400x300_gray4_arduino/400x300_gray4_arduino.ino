...
// 4-gray panel info card for the 4.2" 400x300 SSD1683 E-Ink display (#6381,
// ribbon FPC-190). Flashes a card with the panel's size, chipset, product #,
...
#define CARD_FONT_TITLE 3
#define CARD_FONT_BODY 4
