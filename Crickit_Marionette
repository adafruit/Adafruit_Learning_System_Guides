...
BUTTON_2 = crickit.SIGNAL3  # button #2 connected to signal port 3 & ground
BUTTON_3 = crickit.SIGNAL5  # button #3 connected to signal port 5 & ground
BUTTON_4 = crickit.SIGNAL7  # button #4 connected to signal port 7 & ground

ss.pin_mode(BUTTON_1, ss.INPUT)
ss.pin_mode(BUTTON_2, ss.INPUT)
ss.pin_mode(BUTTON_3, ss.INPUT)
ss.pin_mode(BUTTON_4, ss.INPUT)
