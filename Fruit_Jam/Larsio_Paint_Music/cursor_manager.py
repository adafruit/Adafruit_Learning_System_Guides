...
class CursorManager:
    ...
    def create_cursors(self):
        ...
        self.crosshair_cursor = TileGrid(crosshair_cursor_bitmap, pixel_shader=crosshair_cursor_palette)
        self.triangle_cursor = TileGrid(triangle_cursor_bitmap, pixel_shader=triangle_cursor_palette)
