...
STORY_REQUEST = "Please tell me a story about a fairy who lives in an oak tree and a little girl named Luna who goes on an adventure."

# ChatGPT Parameters
SYSTEM_ROLE = (
    "You are a master AI Storyteller that can tell a story of any length."
)
...
STORY_PROMPT = f"Write a complete story with a title and a body of approximately {STORY_WORD_LENGTH} words long and a happy ending. The specific story request is \"{STORY_REQUEST}\". "
...
if openai.api_key is None:
    print(
        "Please set the OPENAI_API_KEY environment variable first."
    )
    sys.exit(1)
...
def parse_args():
    ...
    parser.add_argument('--rotation', type=int, choices=[90, 270],
                        dest='rotation', action='store', default=90,
