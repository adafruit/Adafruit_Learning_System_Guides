...
if board.board_id == "pyportal_titano":
    screen_width  = 320
    screen_height = 480
    set_backlight(1)    # 0.3 brightness does not cause the display to be visible on the Titano
else:
    screen_width  = 240
    screen_height = 320
    set_backlight(0.3)
...
button_view1  = Button(x                = 0,                  # Start at furthest left
                       y                = 0,                  # Start at top
...
button_view2  = Button(x                = TAPS_WIDTH,         # Start after width of a button
                       y                = 0,
                       width            = TAPS_WIDTH,
                       height           = TAPS_HEIGHT,
                       label            = "View 2",
...
button_view3  = Button(x                = TAPS_WIDTH*2,       # Start after width of 2 buttons
                       y                = 0,
                       width            = TAPS_WIDTH,
                       height           = TAPS_HEIGHT,
                       label            = "View 3",
...
button_switch = Button(x                = 0,                  # Start at furthest left
                       y                = BIG_BUTTON_Y,
...
button_2      = Button(x                = BIG_BUTTON_WIDTH,   # Starts just after button 1 width
                       y                = BIG_BUTTON_Y,
                       width            = BIG_BUTTON_WIDTH,
                       height           = BIG_BUTTON_HEIGHT,
                       label            = "Light Color",
...
text_box(feed2_label, TABS_Y,
         'Tap on the Icon button to meet a new friend.', 18)
...
while True:
    ...
    sensor_data.text = 'Touch: {}\nLight: {}\nTemp: {:.0f}°F'.format(touch, light, get_Temperature(adt))
